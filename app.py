...
def get_vectorstore(text_chunks):
  ...
  # Rodando o processo de embedding localmente
...
def get_conversation_chain(vector_store):
  llm = ChatOpenAI()
  #llm = ChatHuggingFace(model_id="google/flan-t5-xxl", model_kwargs={"temperature":0.5, "max_length": 512})
...
def main():
  ...
  with st.sidebar:
    ...
    pdf_docs = st.file_uploader("Upload your PDFs here and click on 'Send'", accept_multiple_files=True)
    if st.button("Send"):
